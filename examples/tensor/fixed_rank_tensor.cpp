...
int main() {
    ...
    **/
    auto t12 = ub::fixed_rank_tensor<float,5,ub::last_order>{ ub::extents<5>{1,2,2,3,4}, 5.f };
     ...
     * Extents Type: extents<5>{1,2,2,3,4}
    **/
    auto t2 = ub::fixed_rank_tensor( ub::extents<5>{1,2,2,3,4}, 5.f );
    ...
    auto t3 = ub::fixed_rank_tensor( ub::extents<5>{1,2,3,4,5}, 5.f );
    auto st1 = s_tensor{ 5.f };
    auto dt1 = ub::dynamic_tensor( ub::extents<>{1,2,3,4,5}, 5.f );
