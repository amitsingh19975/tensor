...
BOOST_FIXTURE_TEST_CASE_TEMPLATE( test_tensor_expression_retrieve_extents, value,  test_types, fixture)
{
    ...
    for(auto i = 0u; i < extents.size()-1; ++i)
    {
        ...
        // uexpr1 = t1+1
        // uexpr2 = 2+t2
        auto uexpr1 = ublas::detail::make_unary_tensor_expression<tensor_core_type>( t1, uplus1 );
        auto uexpr2 = ublas::detail::make_unary_tensor_expression<tensor_core_type>( t2, uplus2 );
        ...
        auto bexpr_bexpr_uexpr1 = ublas::detail::make_binary_tensor_expression<tensor_core_type>( bexpr_uexpr, t2, bminus );
        ...
        auto bexpr_bexpr_uexpr2 = ublas::detail::make_binary_tensor_expression<tensor_core_type>( t2, bexpr_uexpr, bminus );
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE( test_tensor_expression_all_extents_equal, value,  test_types, fixture)
{
    ...
    for(auto i = 0u; i < extents.size()-1; ++i)
    {
        ...
        auto bexpr_uexpr2 = ublas::detail::make_binary_tensor_expression<tensor_core_type>( uexpr1, t2, bplus );
        ...
        auto bexpr_bexpr_uexpr3 = ublas::detail::make_binary_tensor_expression<tensor_core_type>( bexpr_uexpr2, t1, bplus );
        ...
        auto bexpr_bexpr_uexpr4 = ublas::detail::make_binary_tensor_expression<tensor_core_type>( t1, bexpr_bexpr_uexpr3, bplus );
