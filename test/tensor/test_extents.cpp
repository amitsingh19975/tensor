...
BOOST_FIXTURE_TEST_CASE(test_extents_access, fixture,
  ...
  BOOST_REQUIRE_EQUAL(extents.size(), 14);
  ...
  BOOST_REQUIRE_EQUAL(extents[13].size(), 1);
...
BOOST_FIXTURE_TEST_CASE(test_extents_copy_ctor, fixture,
  ...
  auto e13 = extents[13]; // {1} //free_scalar_type
  ...
  BOOST_REQUIRE_EQUAL(e13.size(), 1);
...
BOOST_FIXTURE_TEST_CASE(test_extents_is, fixture,
  ...
  BOOST_CHECK(!e10.is_free_scalar());
  ...
  BOOST_CHECK(!e11.is_free_scalar());
  ...
  BOOST_CHECK(!e12.is_free_scalar());
  ...
  BOOST_CHECK(e13.is_free_scalar());
}
...
BOOST_FIXTURE_TEST_CASE(test_extents_squeeze, fixture,
  ...
  BOOST_CHECK((e13 == extents_type{1}));
}
...
BOOST_FIXTURE_TEST_CASE(test_extents_product, fixture,
  ...
  BOOST_CHECK_EQUAL(e13, 1);
}

BOOST_FIXTURE_TEST_CASE(test_extents_to_string, fixture,
                        *boost::unit_test::label("extents") *
                        boost::unit_test::label("to_string")) {

  auto e0 = extents[0].to_string();   // {}
  auto e1 = extents[1].to_string();   // {1,1}
  auto e2 = extents[2].to_string();   // {1,2}
  auto e3 = extents[3].to_string();   // {2,1}
  auto e4 = extents[4].to_string();   // {2,3}
  auto e5 = extents[5].to_string();   // {2,3,1}
  auto e6 = extents[6].to_string();   // {1,2,3}
  auto e7 = extents[7].to_string();   // {1,1,2,3}
  auto e8 = extents[8].to_string();   // {1,2,3,1,1}
  auto e9 = extents[9].to_string();   // {4,2,3}
  auto e10 = extents[10].to_string(); // {4,2,1,3}
  auto e11 = extents[11].to_string(); // {4,2,1,3,1}
  auto e12 = extents[12].to_string(); // {1,4,2,1,3,1}
  auto e13 = extents[13].to_string(); // {1}

  BOOST_CHECK_EQUAL(e0, "{}");
  BOOST_CHECK_EQUAL(e1, "{1, 1}");
  BOOST_CHECK_EQUAL(e2, "{1, 2}");
  BOOST_CHECK_EQUAL(e3, "{2, 1}");
  BOOST_CHECK_EQUAL(e4, "{2, 3}");
  BOOST_CHECK_EQUAL(e5, "{2, 3, 1}");
  BOOST_CHECK_EQUAL(e6, "{1, 2, 3}");
  BOOST_CHECK_EQUAL(e7, "{1, 1, 2, 3}");
  BOOST_CHECK_EQUAL(e8, "{1, 2, 3, 1, 1}");
  BOOST_CHECK_EQUAL(e9, "{4, 2, 3}");
  BOOST_CHECK_EQUAL(e10, "{4, 2, 1, 3}");
  BOOST_CHECK_EQUAL(e11, "{4, 2, 1, 3, 1}");
  BOOST_CHECK_EQUAL(e12, "{1, 4, 2, 1, 3, 1}");
  BOOST_CHECK_EQUAL(e13, "{1}");
}
