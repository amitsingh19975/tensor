...
#ifndef _BOOST_NUMERIC_UBLAS_TENSOR_SHAPE_HELPER_HPP_
#define _BOOST_NUMERIC_UBLAS_TENSOR_SHAPE_HELPER_HPP_
...
inline static constexpr ptrdiff_t dynamic_extent = -1;
inline static constexpr ptrdiff_t dynamic_rank = -2;
