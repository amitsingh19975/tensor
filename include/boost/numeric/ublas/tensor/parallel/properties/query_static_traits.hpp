#ifndef _BOOST_UBLAS_TENSOR_PARALLEL_PROPERTIES_QUERY_STATIC_TRAITS_HPP
#define _BOOST_UBLAS_TENSOR_PARALLEL_PROPERTIES_QUERY_STATIC_TRAITS_HPP
...
namespace boost::numeric::ublas::parallel{
    ...
    namespace properties{
        ...
        struct query_static_traits<
            ...
            >    
        >{
            using return_type = decltype( std::decay_t<Property>::template static_query_v< std::decay_t<Entity> > );
            static constexpr auto const is_valid = true;
            static constexpr auto const is_noexcept = true;
        };
...
#endif // _BOOST_UBLAS_TENSOR_PARALLEL_PROPERTIES_QUERY_STATIC_TRAITS_HPP