...
BOOST_FIXTURE_TEST_CASE_TEMPLATE( test_tensor_expression_access, value,  test_types, fixture)
{
    ...
    using tensor_core_type  = typename tensor_type::super_type;
    using tensor_expression_type  = typename tensor_core_type::super_type;
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE( test_tensor_unary_expression, value,  test_types, fixture)
{
    ...
    for(auto const& e : extents) {
        ...
        const auto uexpr = ublas::detail::make_unary_tensor_expression<tensor_core_type>( t, uplus1 );

        for(auto i = 0ul; i < t.size(); ++i)
            BOOST_CHECK_EQUAL( uexpr(i), uplus1(t(i))  );

        auto uexpr_uexpr = ublas::detail::make_unary_tensor_expression<tensor_core_type>( uexpr, uplus1 );
        ...
        BOOST_CHECK( ( std::is_same_v< std::decay_t< decltype(uexpr_e) >, tensor_core_type > )   );

        const auto & uexpr_uexpr_e_e = uexpr_uexpr.e.e;

        BOOST_CHECK( ( std::is_same_v< std::decay_t< decltype(uexpr_uexpr_e_e) >, tensor_core_type > )   );
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE( test_tensor_binary_expression, value,  test_types, fixture)
{
    ...
    for(auto const& e : extents) {
        ...
        auto uexpr1 = ublas::detail::make_unary_tensor_expression<tensor_core_type>( t, uplus1 );
        auto uexpr2 = ublas::detail::make_unary_tensor_expression<tensor_core_type>( t, uplus2 );

        BOOST_CHECK( ( std::is_same_v< std::decay_t< decltype(uexpr1.e) >, tensor_core_type > )   );
        BOOST_CHECK( ( std::is_same_v< std::decay_t< decltype(uexpr2.e) >, tensor_core_type > )   );
        ...
        auto bexpr_uexpr = ublas::detail::make_binary_tensor_expression<tensor_core_type>( uexpr1, uexpr2, bplus );

        BOOST_CHECK( ( std::is_same_v< std::decay_t< decltype(bexpr_uexpr.el.e) >, tensor_core_type > )   );
        BOOST_CHECK( ( std::is_same_v< std::decay_t< decltype(bexpr_uexpr.er.e) >, tensor_core_type > )   );


        for(auto i = 0ul; i < t.size(); ++i)
            BOOST_CHECK_EQUAL( bexpr_uexpr(i), bplus(uexpr1(i),uexpr2(i))  );

        auto bexpr_bexpr_uexpr = ublas::detail::make_binary_tensor_expression<tensor_core_type>( bexpr_uexpr, t, bminus );

        BOOST_CHECK( ( std::is_same_v< std::decay_t< decltype(bexpr_bexpr_uexpr.el.el.e) >, tensor_core_type > )   );
        BOOST_CHECK( ( std::is_same_v< std::decay_t< decltype(bexpr_bexpr_uexpr.el.er.e) >, tensor_core_type > )   );
        BOOST_CHECK( ( std::is_same_v< std::decay_t< decltype(bexpr_bexpr_uexpr.er) >, tensor_core_type > )   );
        BOOST_CHECK( ( std::is_same_v< std::decay_t< decltype(bexpr_bexpr_uexpr.er) >, tensor_core_type > )   );
