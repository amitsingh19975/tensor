...
public:
     ...
     */
    BOOST_UBLAS_INLINE
    tensor ( const tensor &v ) : expression_type()
    {
    ...
    tensor ( const vector_type &v ) : expression_type()
    {
        ...
        if ( !this->elements[0_c].data_.empty() ) {
            this->elements[0_c].extents_ = extents_type{this->elements[0_c].data_.size(), 1};
            this->elements[0_c].strides_ = strides_type ( this->elements[0_c].extents_ );
        }
    }
    ...
    * @param expr matrix expression
    ...
    bool empty() const
    {
        return this->elements[0_c].data_.empty();
    }
    ...
    {
        return this->elements[0_c].data_.size();
    }
    ...
    {
        return this->elements[0_c].extents_.size();
    }
    ...
    {
        return this->elements[0_c].strides_;
    }
    ...
    {
        return this->elements[0_c].extents_;
    }
    ...
    {
        return this->elements[0_c].data_.data();
    }
    ...
    {
        return this->elements[0_c].data_.begin();
    }
    ...
    {
        return this->elements[0_c].data_.cbegin();
    }
    ...
    {
        return this->elements[0_c].data_.end();
    }
    ...
    {
        return this->elements[0_c].data_.cend();
    }
